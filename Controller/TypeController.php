...
use NicoB\ScrumBundle\Form\TypeType;
...
class TypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NicoBScrumBundle:Type')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NicoBScrumBundle:Type')->find($id);
     ...
     * @Method("post")
     * @Template("NicoBScrumBundle:Type:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("NicoBScrumBundle:Type:edit.html.twig")
     */
