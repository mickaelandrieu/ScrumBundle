...
use NicoB\ScrumBundle\Form\PriorityType;
...
class PriorityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NicoBScrumBundle:Priority')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NicoBScrumBundle:Priority')->find($id);
     ...
     * @Method("post")
     * @Template("NicoBScrumBundle:Priority:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("NicoBScrumBundle:Priority:edit.html.twig")
     */
